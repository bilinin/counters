...
#       Первый
        ...
        for i, current in enumerate(res):
            if current == 16:
                begin_pos = i
        print("<br>G1 " + str(float_from_byte(bytearray(res[begin_pos + 3:begin_pos + 7]))))
        print("<br>G2 " + str(float_from_byte(bytearray(res[begin_pos + 7:begin_pos + 11]))))
        print("<br>G3 " + str(float_from_byte(bytearray(res[begin_pos + 11:begin_pos + 15]))))
        print("<br>P1 " + str(float_from_byte(bytearray(res[begin_pos + 15:begin_pos + 19]))))
        print("<br>P2 " + str(float_from_byte(bytearray(res[begin_pos + 19:begin_pos + 23]))))
        print("<br>t1 " + str(float_from_byte(bytearray(res[begin_pos + 23:begin_pos + 27]))))
        print("<br>t2 " + str(float_from_byte(bytearray(res[begin_pos + 27:begin_pos + 31]))))
        print("<br>dt " + str(float_from_byte(bytearray(res[begin_pos + 31:begin_pos + 35]))))
        print("<br>t3 " + str(float_from_byte(bytearray(res[begin_pos + 35:begin_pos + 39]))))
        print("<br>tх " + str(float_from_byte(bytearray(res[begin_pos + 39:begin_pos + 43]))))
        print("<br>tв " + str(float_from_byte(bytearray(res[begin_pos + 43:begin_pos + 47]))))
